...
class LUMWCNN_CPU(nn.Module):
    def __init__(self) -> None:
        super(LUMWCNN_CPU, self).__init__()
        ...
        # DWT, 256 -> 64
        self.r_conv1 = nn.Sequential(*[Conv2d(64, 64, 3), Conv2d(64, 64, 3)])  # 64->64
